import{a as m,f as $,r as E}from"./sidebar-DBGM9-BC.js";import{a as M,s as g}from"./toast-DJo7gZdP.js";const r=document.getElementById("page-content"),h=document.getElementById("modal-root");async function T(n,s){await $(n,s)}function q(n,s,f){if(!n.length)return{rows:`
        <tr class="table-row">
