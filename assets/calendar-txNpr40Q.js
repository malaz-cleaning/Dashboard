import{a as u}from"./auth-CC3zXfFT.js";/* empty css               */import"./main-CZdBdtSK.js";import"./common-B6Mb1_rC.js";import{a as c}from"./sidebar-84I8JWhY.js";function p(e){return`<span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium border bg-slate-800 text-slate-200">${{pending:"معلقة",in_progress:"قيد التنفيذ",done_unpaid:"تمت ولم يُدفع",done_paid:"تمت ودُفع",cancelled:"ملغاة"}[e]||e}</span>`}const l=document.getElementById("page-content");function v(e){return"EGP "+Number(e||0).toLocaleString("ar-EG")}function f(e){if(!e)return"غير محدد";try{return new Date(e).toISOString().split("T")[0]}catch{return e}}function x(e,i,d,o){const r=i.map(n=>{const t=d.find(s=>s.client_id===n.client_id)||{},a=o.find(s=>s.chalet_id===n.chalet_id)||{};return`
