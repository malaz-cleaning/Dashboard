import{a as m,d as $,e as E}from"./sidebar-jGvh9J_S.js";import{a as M,s as g}from"./toast-DJo7gZdP.js";const r=document.getElementById("page-content"),h=document.getElementById("modal-root");async function T(n,s){await $(n,s)}function q(n,s,f){if(!n.length)return{rows:`
        <tr class="table-row">
