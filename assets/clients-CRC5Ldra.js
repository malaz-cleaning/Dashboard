import{a as y,g as $,r as C}from"./sidebar-BYx7eQyN.js";import{a as E,s as w}from"./toast-DJo7gZdP.js";const c=document.getElementById("page-content"),x=document.getElementById("modal-root");async function M(a){await $(a)}function j(a,f,v){if(!a.length)return{rows:`
        <tr class="table-row">
